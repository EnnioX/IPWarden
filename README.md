...
### 4x01端口服务未授权访问漏洞（http://127.0.0.1:8088/portvuln）
...
### 4x02Web站点探测（http://127.0.0.1:8088/web）
...
### 4x03xray扫描（http://127.0.0.1:8088/xray）

![xay扫描风险](./img/xrayapi.png)

### 4x04nuclei扫描（http://127.0.0.1:8088/nuclei）
