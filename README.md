...
| 2    | 查询指定ip开放的端口     | GET  | http://127.0.0.1/ip=?         | ip(string)   | port : 端口<br />protocol : 端口协议<br />updatetime : 扫描更新时间                                                                                                | json     |
| 3    | 查询开放指定端口的ip     | GET  | http://127.0.0.1/port=?       | port(string) | ip : ip地址<br />updatetime : 扫描更新时间                                                                                                                         | json     |
